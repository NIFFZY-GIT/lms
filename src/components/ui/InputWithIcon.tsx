...
export const InputWithIcon = ({ icon, registration, error, className, ...props }: InputProps) => (
  <div>
      ...
      <input
        ...
        className={twMerge(
            `block w-full rounded-md border-0 py-2.5 pl-10 text-gray-900 ring-1 ring-inset ${
                error ? 'ring-red-300 placeholder:text-red-300 focus:ring-red-500' : 'ring-gray-300 placeholder:text-gray-400 focus:ring-indigo-600'
